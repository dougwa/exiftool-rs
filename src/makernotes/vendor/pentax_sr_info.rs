...
static PENTAX_SR_INFO_PC_0: &[(i64, &str)] = &[(0, "Not stabilized")];
...
pub static PENTAX_SR_INFO: BinTable = BinTable {
    ...
    first_entry: 0,
    tags: &[
    BinTag { index: 0, name: "SRResult", fmt: None, pc: Pc::Enum(PENTAX_SR_INFO_PC_0), skip: Skip::Never, count: Count::Fixed(1) },
