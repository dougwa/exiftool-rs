...
// FlashOptions/FlashOptions2 (Mask 0xf0), AFPointMode (Mask 0xf0 + BITMASK) and
// AFPointSelected2 (BITMASK) are handled in pentax special() (Pc::None).
...
pub static PENTAX_CAMERA_SETTINGS: BinTable = BinTable {
    ...
    BinTag { index: 2, name: "FlashOptions", fmt: None, pc: Pc::None, skip: Skip::Never, count: Count::Fixed(1) },
    BinTag { index: 3, name: "AFPointMode", fmt: None, pc: Pc::None, skip: Skip::Never, count: Count::Fixed(1) },
    BinTag { index: 4, name: "AFPointSelected2", fmt: Some(Fmt::U16), pc: Pc::None, skip: Skip::Never, count: Count::Fixed(1) },
    ...
    BinTag { index: 16, name: "FlashOptions2", fmt: None, pc: Pc::None, skip: Skip::Never, count: Count::Fixed(1) },
