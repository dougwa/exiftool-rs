...
static NIKON_AFINFO_PC_2: &[(i64, &str)] = &[(2047, "All 11 Points"), (0, "(none)")];
...
pub static NIKON_AFINFO: BinTable = BinTable {
    ...
    BinTag { index: 2, name: "AFPointsInFocus", fmt: Some(Fmt::U16), pc: Pc::Enum(NIKON_AFINFO_PC_2), skip: Skip::Never, count: Count::Fixed(1) },
    ],
};
